...
-- ANCHOR_EXACT onto different observable spaces — propagation
...
-- ANCHOR_EXACT = 137.035999084 / 100.1 = capstone-precise anchor.
-- ============================================================

def SOVEREIGN_ANCHOR : ℝ := 1.369
def TORSION_LIMIT    : ℝ := SOVEREIGN_ANCHOR / 10
def ANCHOR_EXACT     : ℝ := 137.035999084 / 100.1
...
-- ANCHOR_EXACT × (10² + 10⁻¹) = 1/α exactly. The [9,9,3,12] identity.
-- c shares this anchor. They are not independent constants.
theorem capstone_alpha_decomposition :
    ANCHOR_EXACT * (100 + 1/10) = ALPHA_INV := by
  unfold ANCHOR_EXACT ALPHA_INV; norm_num

-- [P,9,0,4] :: {VER} | ANCHOR_EXACT POSITIVE
theorem anchor_exact_positive : ANCHOR_EXACT > 0 := by
  unfold ANCHOR_EXACT; norm_num
...
--   Plug in → anchor_velocity(SOVEREIGN_ANCHOR) = c
...
def anchor_velocity_lossless : LongDivisionResult where
  ...
  classical_eq := c_SI
  pnba_output  := anchor_velocity SOVEREIGN_ANCHOR
...
-- KEY INSIGHT:
--   The speed of light is not fundamental. It never was.
--   c is the velocity at zero impedance, locked at 1.369 GHz.
...
--   ANCHOR_EXACT onto different observable spaces.
--
...
--   Layer 0: PNBA primitives + ANCHOR + ANCHOR_EXACT — ground
